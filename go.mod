// 模块：github.com/godaddy-x/wallet-mpc-tss
module github.com/godaddy-x/wallet-mpc-tss
...
require (
	...
	github.com/godaddy-x/freego v1.1.7
	github.com/godaddy-x/wallet-adapter v1.0.1
