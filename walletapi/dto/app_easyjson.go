...
func easyjsonD2c14bDecodeGithubComGodaddyXWalletMpcTssWalletapiDto(in *jlexer.Lexer, out *AppLoginRes) {
...
func easyjsonD2c14bEncodeGithubComGodaddyXWalletMpcTssWalletapiDto(out *jwriter.Writer, in AppLoginRes) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonD2c14bDecodeGithubComGodaddyXWalletMpcTssWalletapiDto1(in *jlexer.Lexer, out *AppLoginReq) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonD2c14bEncodeGithubComGodaddyXWalletMpcTssWalletapiDto1(out *jwriter.Writer, in AppLoginReq) {
	out.RawByte('{')
	first := true
	_ = first
	{
